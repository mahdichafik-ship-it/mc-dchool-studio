...
**How to apply:** Confirm the remote base tag/ref and final release object through GitHub before creating the next tag. Use the repository's existing desktop release workflow and verify the completed release contains both architecture installers, ZIPs, blockmaps, and `latest-mac.yml` before telling the user to update.