...
The user confirmed resumable uploads succeeded in production on 2026-09-10. Large originals still incur real transfer time; measure metadata-request savings separately from network throughput.