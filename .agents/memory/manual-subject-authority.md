...
**How to apply:** Enforce the same precedence in production watcher paths, sequence helpers, file-drop paths, tests, offline/restart behavior, and both school and corporate projects. Preserve JPEG/RAW ownership across delayed pair arrival, and fail visibly instead of silently reassigning a capture.