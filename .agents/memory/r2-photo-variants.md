...
**How to apply:** Generate base thumbnail and preview variants after original verification, repair missing variants on demand, verify uploaded derivative metadata, and serve them only through authorized routes. Only signed media-token preview URLs may be shared-cacheable; session-authorized previews and originals stay private. A studio action labeled “Download original” must stream the verified source object bytes directly; never route it through thumbnail, preview, download-derivative, or print-derivative generation.