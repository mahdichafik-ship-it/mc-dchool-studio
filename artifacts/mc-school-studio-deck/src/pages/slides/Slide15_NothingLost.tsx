export default function Slide15_NothingLost() {
  return (
      ...
      <div className="flex flex-col h-full px-[8vw] pt-[8vh] pb-[6vh]">
        ...
        <div className="flex flex-col gap-[2vh] flex-1">
          <div className="flex items-center gap-[2vw] bg-slate-800/60 rounded-2xl px-[3vw] py-[2.5vh]">
            ...
            <p className="text-[2.1vw] font-body text-slate-200">Projects, rosters, and photos live in the cloud permanently</p>
          </div>
          <div className="flex items-center gap-[2vw] bg-slate-800/60 rounded-2xl px-[3vw] py-[2.5vh]">
            <div className="w-[0.9vw] h-[0.9vw] rounded-full bg-primary shrink-0" />
            <p className="text-[2.1vw] font-body text-slate-200">Re-sync the desktop app for a re-shoot or makeup day</p>
          </div>
          <div className="flex items-center gap-[2vw] bg-slate-800/60 rounded-2xl px-[3vw] py-[2.5vh]">
            <div className="w-[0.9vw] h-[0.9vw] rounded-full bg-primary shrink-0" />
            <p className="text-[2.1vw] font-body text-slate-200">Add late-enrolling students on the web, re-sync, keep shooting</p>
          </div>
          <div className="flex items-center gap-[2vw] bg-slate-800/60 rounded-2xl px-[3vw] py-[2.5vh]">
            <div className="w-[0.9vw] h-[0.9vw] rounded-full bg-primary shrink-0" />
            <p className="text-[2.1vw] font-body text-slate-200">No USB drives, no emailed spreadsheets, no data silos</p>
          </div>
        </div>
      </div>
    </div>
