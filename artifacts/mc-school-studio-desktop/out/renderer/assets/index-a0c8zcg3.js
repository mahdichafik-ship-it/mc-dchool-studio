 ...
 */
var REACT_ELEMENT_TYPE$2 = /* @__PURE__ */ Symbol.for("react.transitional.element"), REACT_FRAGMENT_TYPE$2 = /* @__PURE__ */ Symbol.for("react.fragment");
 ...
 * LICENSE file in the root directory of this source tree.
 */
var REACT_ELEMENT_TYPE$1 = /* @__PURE__ */ Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE$2 = /* @__PURE__ */ Symbol.for("react.portal"), REACT_FRAGMENT_TYPE$1 = /* @__PURE__ */ Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE$1 = /* @__PURE__ */ Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE$1 = /* @__PURE__ */ Symbol.for("react.profiler"), REACT_CONSUMER_TYPE$1 = /* @__PURE__ */ Symbol.for("react.consumer"), REACT_CONTEXT_TYPE$1 = /* @__PURE__ */ Symbol.for("react.context"), REACT_FORWARD_REF_TYPE$1 = /* @__PURE__ */ Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE$1 = /* @__PURE__ */ Symbol.for("react.suspense"), REACT_MEMO_TYPE$1 = /* @__PURE__ */ Symbol.for("react.memo"), REACT_LAZY_TYPE$1 = /* @__PURE__ */ Symbol.for("react.lazy"), MAYBE_ITERATOR_SYMBOL$1 = Symbol.iterator;
...
var Internals = {
  ...
  p: 0,
  findDOMNode: null
}, REACT_PORTAL_TYPE$1 = /* @__PURE__ */ Symbol.for("react.portal");
...
const Button = reactExports.forwardRef(
  ({ className, variant, size, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-slate-50 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-60 flex-shrink-0 bg-[#0f172a] flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 px-3 py-4 space-y-1", children: [
        ...
        projectName && currentPage === "project-view" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-3 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-slate-500 mb-1", children: [
...
function useStudents(projectId, classId) {
  const [data, setData] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(false);
  const load = reactExports.useCallback(async () => {
    if (!projectId) return;
...
function useCaptures(studentId) {
  ...
  const [dataStudentId, setDataStudentId] = reactExports.useState(null);
  const [livePreview, setLivePreview] = reactExports.useState(null);
  const [loading, setLoading] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const liveTraceRef = reactExports.useRef(void 0);
  const activeStudentIdRef = reactExports.useRef(studentId);
  ...
  const visibleData = dataStudentId === studentId ? data : { captures: [], qrMarkers: [] };
...
function Toaster() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-4 right-4 z-50 flex flex-col gap-2 w-80", children: toasts.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: cn(
      ...
      children: [
        t.type === "success" && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "size-5 text-green-500 shrink-0 mt-0.5" }),
        t.type === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "size-5 text-red-500 shrink-0 mt-0.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-slate-900", children: t.title }),
          t.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 text-xs mt-0.5", children: t.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => dismiss(t.id), className: "text-slate-400 hover:text-slate-600 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-4" }) })
      ]
    },
    t.id
  )) });
...
function ProjectList({ onOpenProject, offline = false }) {
  ...
  const [pullingId, setPullingId] = reactExports.useState(null);
  async function handleOpenSync() {
    ...
    setSyncLoading(true);
    try {
      const result = await window.api.invoke("cloud:listProjects");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-auto px-8 py-6", children: [
      ...
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-red-500 text-sm bg-red-50 p-4 rounded-lg", children: error }),
      !loading && projects.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-64 text-center", children: [
    ...
    syncOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[80vh] flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 border-b border-slate-200 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-teal-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "size-5 text-teal-600" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-slate-900", children: "Sync from Cloud" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: "Select a project to pull locally" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            onClick: () => {
              if (!pullingId) setSyncOpen(false);
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-auto p-4", children: [
        syncLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 py-12 text-slate-500 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "size-4 animate-spin" }),
          "Connecting to cloud…"
        ] }),
        syncError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "size-5 text-red-500 shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-teal-50 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "size-4 text-teal-600" }) }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 shrink-0 ml-3", children: [
                  alreadyLocal && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs text-slate-400", children: "Local copy exists" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        isPulling ? /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "size-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "size-3.5" }),
      ...
      !syncLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-3 border-t border-slate-100 flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: handleOpenSync,
    ...
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-4", children: [
          ...
          p.watchFolder && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "success", children: "Watch folder set" })
        ] })
      ]
    }
  );
...
function Dialog({ open, onClose, title, children, className }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("relative bg-white rounded-xl shadow-2xl w-full max-w-md p-6", className), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-slate-900", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-slate-400 hover:text-slate-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-5" }) })
      ] }),
      children
    ] })
  ] });
...
function ProjectView({ projectId, onBack, offline = false }) {
  ...
  reactExports.useEffect(() => {
    ...
    void window.api.invoke("upload:getQueue", { projectId }).then((items) => setUploadQueue(items));
  }, [
    uploadDialogOpen,
    projectId,
    liveUpload?.pending,
  ...
  async function handleDropForStudent(studentId, event) {
  ...
  const errCount = liveUpload ? liveUpload.error : errorPhotoIds.length;
  const uploadingCount = liveUpload ? liveUpload.uploading : [...uploadStatusMap.values()].reduce((count, s) => count + s.uploading, 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        dropProgress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-5 left-1/2 z-40 -translate-x-1/2 rounded-xl border border-teal-200 bg-white px-5 py-3 shadow-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm font-bold text-slate-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "size-4 animate-spin text-teal-600" }),
            "Importing photos ",
            Math.min(dropProgress.completed, dropProgress.total),
            "/",
            dropProgress.total
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 h-1.5 w-64 overflow-hidden rounded-full bg-slate-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "h-full rounded-full bg-teal-500 transition-all",
              style: {
                width: `${dropProgress.total > 0 ? Math.min(100, dropProgress.completed / dropProgress.total * 100) : 0}%`
              }
            }
          ) })
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 text-[11px] font-medium text-slate-400 mt-0.5 whitespace-nowrap", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-1 rounded-full bg-slate-700 sm:hidden" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-300 sm:hidden", children: captureSummary.total > 0 ? `${captureSummary.total} captures` : `${project?.photoCount ?? 0} photos` })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 shrink-0", children: [
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[11px] font-medium leading-none", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(LocalIcon, { className: cn("size-3.5", localColor) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(localColor === "text-slate-400" ? "text-slate-400" : "text-slate-200"), children: localText })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[11px] font-medium leading-none", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CloudIcon, { className: cn("size-3.5", cloudColor) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn(cloudColor === "text-slate-400" || cloudColor === "text-slate-500" ? "text-slate-400" : "text-slate-200"), children: cloudText })
                    ] })
                  ] }),
                  showUploadDots && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 items-center pl-1.5 border-l border-slate-800 h-6", children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: cn(
                        "w-1.5 h-1.5 rounded-full transition-all duration-300",
                        i < activeDots ? "bg-teal-400 animate-pulse" : "bg-slate-800"
                      )
                    },
                    i
                  )) }),
                  !showUploadDots && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-0.5 flex items-center opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "size-3.5 text-slate-500" }) })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("w-px h-full md:hidden", liveUpload?.enabled ? "bg-blue-500/30" : "bg-slate-800") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => void openUploadDialog(),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-56 space-y-2 overflow-y-auto rounded-lg border border-slate-200 bg-white p-2", children: uploadQueue.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-2 py-4 text-center text-sm text-slate-500", children: "No files are waiting." }) : uploadQueue.map((item) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-slate-100 bg-slate-50 px-3 py-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm font-bold text-slate-800", children: item.fileName }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "truncate text-xs text-slate-500", children: [
                          item.subject,
                          " · ",
                          item.kind === "group" ? "Group" : "Portrait",
                          " · ",
                          item.fileRole
                        ] })
                      ] }),
                    ...
                    (item.attempts > 0 || item.lastError || item.blockedReason) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 text-xs text-slate-500", children: [
                      ...
                      waitingForRetry && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                        " · retry at ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      className: cn(
        ...
        isDropActive ? "bg-teal-100 border-l-4 border-l-teal-600 ring-2 ring-inset ring-teal-300" : isActive ? "bg-teal-50/50 border-l-4 border-l-teal-500" : isSelected ? "bg-slate-50 border-l-4 border-l-transparent" : "hover:bg-slate-50 border-l-4 border-l-transparent border-b-slate-100"
      ),
...
function StudentDetail({
  ...
  const livePreviewMatchesLatest = Boolean(
    isFollowingLatest && livePreview?.photo.previewUrl && latestCapture?.legacyPhoto && (livePreview.previewKey && livePreview.previewKey === latestCapture.legacyPhoto.previewKey || livePreview.photo.id === latestCapture.legacyPhoto.id || livePreview.photo.filePath === latestCapture.legacyPhoto.filePath)
  );
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    const handleReviewShortcut = (event) => {
      ...
      if (event.key === "ArrowLeft" || event.key === "ArrowRight") {
        event.preventDefault();
        const currentIndex = isFollowingLatest ? captures.length - 1 : captures.findIndex((capture) => capture.id === selectedCapture?.id);
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-end gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "mr-1.5 size-3.5" }),
                    " Show QR"
                  ]
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4 sm:p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto flex flex-col gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid min-w-0 grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_164px]", children: [
              ...
              ) : selectedCapture ? /* @__PURE__ */ jsxRuntimeExports.jsx(CaptureStage, { capture: selectedCapture }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex aspect-[16/7] min-h-[220px] items-center justify-center rounded-2xl border border-slate-200 bg-slate-900 text-center text-sm font-semibold text-slate-400", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "mx-auto mb-3 size-9 text-slate-600" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Latest JPEG preview will appear here" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs font-medium text-slate-500", children: "Ready for the next capture" })
              ] }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                PersistentQrCard,
                {
            ...
            selectedCapture && /* @__PURE__ */ jsxRuntimeExports.jsx(
              CaptureStageMeta,
              {
            ...
            !isFollowingLatest && selectedCapture && latestCapture && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2.5 text-xs text-amber-950", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Manual review:" }),
                " browsing this capture does not change the active ",
                employeeLabel.toLowerCase(),
                " or capture target."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "ml-1 rounded border border-amber-300 bg-amber-100 px-1 py-0.5 text-[9px]", children: "L" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CaptureFilmstrip,
              {
                ...
                onNext: () => {
                  const index2 = isFollowingLatest ? captures.length - 1 : captures.findIndex((capture) => capture.id === selectedCapture?.id);
                  if (index2 >= 0 && index2 < captures.length - 1) {
                    const nextCapture = captures[index2 + 1];
                    setReviewCaptureKey(nextCapture.id === latestCapture?.id ? null : captureReviewKey(nextCapture));
                  }
                }
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-extrabold text-teal-600 uppercase tracking-widest bg-teal-50 px-3.5 py-1.5 rounded-full border border-teal-100 shadow-sm w-fit", children: "Capture review" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Dialog,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
              student.simpleQr ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex aspect-square w-64 max-w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "mb-2 size-8 text-slate-300" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-slate-500 text-center", children: "QR not generated" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[10px] font-medium text-slate-400 text-center", children: "Generate in the web app" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "w-full truncate rounded-lg border border-slate-100 bg-slate-50 px-3 py-2 text-center font-mono text-[11px] font-medium text-slate-500", children: [
                student.firstName,
                ".",
                student.lastName,
                ".",
...
function captureUploadSummary(capture, legacyUploadStatus) {
  const statuses = capture.files.map((file) => file.uploadStatus);
  const status = legacyUploadStatus?.uploadStatus ?? (statuses.includes("error") ? "error" : statuses.includes("uploading") ? "uploading" : statuses.includes("pending") ? "pending" : statuses.length > 0 && statuses.every((fileStatus) => fileStatus === "done") ? "done" : null);
  if (status === "error") return { label: "Upload error", className: "text-rose-600", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "size-3.5" }) };
  if (status === "uploading") return { label: "Uploading", className: "text-blue-600", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "size-3.5 animate-spin" }) };
  if (status === "pending") return { label: "Queued", className: "text-amber-600", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CloudUpload, { className: "size-3.5" }) };
  if (status === "done") return { label: "Synced", className: "text-emerald-600", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "size-3.5" }) };
  return { label: "Local", className: "text-slate-500", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "size-3.5" }) };
}
function captureReviewKey(capture) {
...
function PersistentQrCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex size-[92px] shrink-0 items-center justify-center rounded-xl border border-teal-100 bg-white p-2 shadow-inner sm:size-[104px] lg:size-[132px] lg:p-2.5", children: student.simpleQr ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: student.simpleQr,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "size-7 text-slate-300" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 text-[9px] font-bold uppercase tracking-wide text-slate-400", children: "Not generated" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1 lg:w-full lg:flex-none lg:text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[9px] font-extrabold uppercase tracking-[.16em] text-teal-800 lg:justify-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "size-3.5" }),
            "Capture QR"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 truncate font-mono text-[10px] font-semibold text-teal-950", title: `${student.firstName}.${student.lastName}.${student.generatedStudentId}`, children: [
            student.firstName,
            ".",
            student.lastName,
            ".",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-sm sm:grid-cols-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 flex items-center gap-0.5", "aria-label": `${capture.rating} out of 5 stars`, children: Array.from({ length: 5 }, (_, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          type: "button",
          title: `Rate ${index2 + 1} out of 5`,
          "aria-label": `Rate ${index2 + 1} out of 5`,
          onClick: () => onUpdateReview(capture.id, { rating: index2 + 1 }),
          className: "rounded p-0.5 hover:bg-amber-50",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "size-3.5 text-amber-400", fill: index2 < capture.rating ? "currentColor" : "none" })
        },
        index2
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-extrabold uppercase tracking-widest text-slate-400", children: "Pairing" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn("mt-2 truncate text-xs font-bold", capture.pairingStatus === "unpaired" ? "text-rose-600" : "text-slate-700"), children: capture.pairingStatus === "complete" ? "JPEG + RAW" : capture.pairingStatus === "jpeg_only" ? "JPEG only" : capture.pairingStatus === "raw_only" ? "RAW only" : capture.pairingStatus === "unpaired" ? "Needs review" : "Pending" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-extrabold uppercase tracking-widest text-slate-400", children: "Upload" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("mt-2 flex items-center gap-1 text-[10px] font-extrabold uppercase tracking-wider", upload.className), children: [
        upload.icon,
        " ",
        upload.label
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2 sm:justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "mr-1 inline size-3" }),
            " ",
            capture.selected ? "Selected" : "Select"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "mr-1 inline size-3", fill: capture.favorite ? "currentColor" : "none" }),
            " ",
            capture.favorite ? "Favorite" : "Favorite"
          ]
        }
      )
    ] })
...
function CaptureFilmstrip({
  ...
  reactExports.useEffect(() => {
    ...
    strip.querySelector(`[data-filmstrip-capture="${selectedCaptureId}"]`)?.scrollIntoView({ block: "nearest", inline: "nearest", behavior: "smooth" });
  }, [captures.length, isFollowingLatest, selectedCaptureId]);
  if (captures.length === 0) return null;
  const latestCaptureId = captures[captures.length - 1].id;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-slate-200 bg-white p-3 shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex flex-wrap items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-extrabold uppercase tracking-[.18em] text-slate-500", children: "Recent captures" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] text-slate-400", children: "Newest on the right · click to review without changing target" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            title: "Next capture",
            className: "rounded-lg border border-slate-200 p-1.5 text-slate-600 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-35",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "size-3.5" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isFollowingLatest ? "Following latest" : "Latest capture"
          }
        )
      ] })
    ] }),
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 bg-white px-2 py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] text-slate-500", children: new Date(capture.capturedAt).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-[9px] font-extrabold uppercase", capture.pairingStatus === "complete" ? "text-emerald-600" : capture.pairingStatus === "unpaired" ? "text-rose-600" : "text-slate-500"), children: capture.pairingStatus === "complete" ? "JPG+RAW" : capture.pairingStatus === "jpeg_only" ? "JPG" : capture.pairingStatus.replace("_", " ") })
            ] })
          ]
        },
        capture.id
...
function CaptureTile({
  ...
  if (photo) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative flex w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md", children: [
      ...
      zoomOpen && zoomSource && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          role: "dialog",
          "aria-modal": "true",
...
function ReassignDialog({
  ...
  const { data: students } = useStudents(projectId);
...
function Settings({
  ...
  async function handleChoosePhotosDir() {
    const selected = await window.api.invoke("dialog:openFolder");
    if (!selected) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border-b border-slate-200 px-8 py-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-500 mt-0.5", children: "Application preferences" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-auto px-8 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-teal-50 border border-teal-200 rounded-xl p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "size-5 text-teal-600" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-teal-800", children: "Photo day workflow" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "text-sm text-teal-700 space-y-1.5 list-decimal list-inside", children: [
