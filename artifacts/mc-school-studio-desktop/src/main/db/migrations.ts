...
export function ensureLegacyColumns(sqlite: SqliteSchemaDatabase): void {
  const migrations: ReadonlyArray<readonly [string, string, string]> = [
    ...
    ['students', 'guardian_first_name', 'TEXT'],
    ['students', 'guardian_last_name', 'TEXT'],
    ['students', 'company', 'TEXT'],
    ['students', 'address_line_1', 'TEXT'],
    ['students', 'address_line_2', 'TEXT'],
    ['students', 'city', 'TEXT'],
    ['students', 'state_province', 'TEXT'],
    ['students', 'zip_postal_code', 'TEXT'],
    ['students', 'country', 'TEXT'],
    ['students', 'contact_note', 'TEXT'],
