...
test('upgrades an older local database without replacing existing rows', () => {
  ...
  assert(columns.get('students')?.has('school_id'))
  assert(columns.get('students')?.has('guardian_first_name'))
  assert(columns.get('students')?.has('guardian_last_name'))
  assert(columns.get('students')?.has('company'))
  assert(columns.get('students')?.has('address_line_1'))
  assert(columns.get('students')?.has('address_line_2'))
  assert(columns.get('students')?.has('city'))
  assert(columns.get('students')?.has('state_province'))
  assert(columns.get('students')?.has('zip_postal_code'))
  assert(columns.get('students')?.has('country'))
  assert(columns.get('students')?.has('contact_note'))
  ...
  assert.equal(columns.get('students')?.size, 25)
})
