        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
              Your JPEG and RAW files are protected by the platform owner Google Drive from the start. Connect your own Google Drive or Dropbox, then keep both backups or turn off the platform service.
            </p>
          </div>
        </div>
