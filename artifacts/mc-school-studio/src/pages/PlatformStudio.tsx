  ...
  return (
    <div className="flex-1 overflow-auto bg-slate-50 p-5 sm:p-8">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="overflow-hidden rounded-xl border bg-white">
           <div className="border-b p-5"><h2 className="font-semibold">Studio storage connections</h2><p className="mt-1 text-sm text-slate-500">OAuth access is refreshed automatically. Studios can use their own provider alone or keep the managed platform fallback as a second copy.</p></div>
