...
import { RETIREMENT_LIMITATION, desktopConnectionStatus } from "@/lib/desktopConnectionStatus";
...
export default function Team() {
  ...
  return <div className="flex-1 overflow-auto bg-slate-50 p-8">
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      {canManage && <form data-testid="team-invite-form" onSubmit={invite} className="rounded-xl border bg-white p-5 shadow-sm">
      ...
      {canManage && <div data-testid="team-project-assignments" className="rounded-xl border bg-white p-5 shadow-sm">
       ...
       {canManage && <div data-testid="team-desktop-connections" className="rounded-xl border bg-white p-5 shadow-sm">
         ...
         <p className="mt-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs leading-5 text-amber-800">{RETIREMENT_LIMITATION}</p>
